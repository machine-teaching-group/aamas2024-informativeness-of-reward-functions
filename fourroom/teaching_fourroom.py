...
class teaching():
    ...
    teacher_args = hyper_parameters.teacher_args_4room
...
if __name__ == "__main__":
    ...
    parser.add_argument('--epsilon_greedy', default=0.4, type=float, help='epsilon_greedy for calculating mu')
    ...
    for i in range(0, args.n_averaged):
        ...
        for gridsizefull in [7]:
            ...
            for teacher_name in teachers:
                ...
                utils.write_into_file(accumulator=dict_acc, exp_iter=i + 1,
