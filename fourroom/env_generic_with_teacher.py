...
class EnvTeacher(gym.Env):
    ...
    def __init__(self, env, args, teacher_name, epsilon_greedy):
        ...
        if self.teacher_name == "Ada_TL":
            ...
            _, self.phi_EXPRD = fourroom_reward_design.reward_design_model_based(env_0=self.env,
                                                                                     pi_d_T=self.pi_d_T,
                                                                                     pi_s_T=self.pi_s_T,
                                                                                     pi_d_L=None,
                                                                                     pi_s_L=None,
            ...
            _, self.phi_Invariance = fourroom_reward_design.reward_design_model_based(env_0=self.env,
                                                                                 pi_d_T=self.pi_d_T,
                                                                                 pi_s_T=self.pi_s_T,
                                                                                 pi_d_L=None,
                                                                                 pi_s_L=None,
    ...
    def update_Ada_TL(self, D, agent):
        ...
        _, self.phi_Ada_TL = fourroom_reward_design.reward_design_model_based(env_0=self.env,
                                                                              pi_d_T=self.pi_d_T,
                                                                              pi_s_T=self.pi_s_T,
                                                                              pi_d_L=None,
